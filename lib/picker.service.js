...
var PickerService = (function () {
    ...
    Object.defineProperty(PickerService.prototype, "dtMinDate", {
        get: function () {
    ...
    Object.defineProperty(PickerService.prototype, "dtMaxDate", {
        get: function () {
    ...
    PickerService.prototype.setPickerOptions = function (dtLocale, dtViewFormat, dtReturnObject, dtPositionOffset, dtMode, dtHourTime, dtTheme, dtPickerType, dtMinDate, dtMaxDate) {
    ...
    PickerService.prototype.setMoment = function (value, minDate, maxDate) {
        if (value) {

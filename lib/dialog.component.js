...
var DialogComponent = (function () {
    ...
    DialogComponent.prototype.openDialog = function (moment, minDate, maxDate) {
        this.show = true;
    ...
    DialogComponent.prototype.setSelectedMoment = function (moment, minDate, maxDate) {
    ...
    DialogComponent.prototype.setDialog = function (instance, elementRef, initialValue, dtLocale, dtViewFormat, dtReturnObject, dtPositionOffset, dtMode, dtHourTime, dtTheme, dtPickerType, dtMinDate, dtMaxDate, date) {
        this.directiveInstance = instance;
        this.directiveElementRef = elementRef;
        this.initialValue = initialValue;
        this.date = date;
        this.service.setPickerOptions(dtLocale, dtViewFormat, dtReturnObject, dtPositionOffset, dtMode, dtHourTime, dtTheme, dtPickerType, dtMinDate, dtMaxDate);
    };

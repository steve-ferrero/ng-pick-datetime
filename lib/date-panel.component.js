...
var DatePanelComponent = (function () {
    ...
    DatePanelComponent.prototype.compare = function(date, day, type){
        if(date){
            if(type === 'min'){
                if(moment(day.format()).isAfter(moment(date).format('YYYY-MM-DD'))){
                    return false;
                }
            }
            if(type === 'max'){
                if(moment(day.format()).isBefore(moment(date).format('YYYY-MM-DD'))){
                    return false;
                }
            }
            return true;
